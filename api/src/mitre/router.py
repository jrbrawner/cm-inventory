...
@router.get(
    "/api/mitre/tactics/basic", response_model=list[TacticBasic], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/tactic/{id}/techniques", response_model=TacticTechnique, tags=["mitre"]
)
def get_mitre_tactic_techniques(id: str, db: Session = Depends(get_db)):
    ...
    if techniques is None:
        raise HTTPException(
            400, "Error in retrieving techniques associated with that tactic."
        )
    return techniques


@router.get(
    "/api/mitre/tactic/{id}/yara", response_model=Page[YaraSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/tactic/{id}/snort", response_model=Page[SnortSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/tactic/{id}/sigma", response_model=Page[SigmaSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/technique/{id}/yara", response_model=Page[YaraSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/technique/{id}/snort", response_model=Page[SnortSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/technique/{id}/sigma", response_model=Page[SigmaSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/subtechnique/{id}/yara", response_model=Page[YaraSchema], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/subtechnique/{id}/snort",
    response_model=Page[SnortSchema],
    tags=["mitre"],
)
...
@router.get(
    "/api/mitre/subtechnique/{id}/sigma",
    response_model=Page[SigmaSchema],
    tags=["mitre"],
)
...
@router.get(
    "/api/mitre/tactic/{type}/{term}", response_model=TacticBase, tags=["mitre"]
)
...
@router.get(
    "/api/mitre/techniques", response_model=list[TechniqueTactics], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/techniques-tactics-subtechniques-basic",
    response_model=list[TechniqueTacticSubtechniqueBasic],
    tags=["mitre"],
)
...
@router.get(
    "/api/mitre/technique/{id}", response_model=TechniqueExtended, tags=["mitre"]
)
...
@router.get(
    "/api/mitre/subtechniques", response_model=list[SubTechniqueBase], tags=["mitre"]
)
...
@router.get(
    "/api/mitre/subtechnique/{id}", response_model=SubTechniqueExtended, tags=["mitre"]
)
...
def create_mitre_layer(
    form_data: LayerRequest = Depends(LayerRequest.as_form),
    ...
    layer = layer_generator.generate_mitre_layer(
        layer_name=form_data.layer_name,
        description=form_data.layer_description,
...
def generate_heatmap(
    ...
    return {
        "results": "Layer created with countermeasure data.",
        "visualization": file_text,
    }
