        ...
        <Container className="mt-2">
            <Row md={3}>
                <Col>
                    <Card className="mb-2" bg="light">
                        <Card.Body>
                            ...
                            <Card.Text>
                                Explore data and countermeasures associated with MITRE ATT&CK tactics.
                            </Card.Text>
                ...
                <Col>
                    <Card className="mb-2" bg="light">
                        <Card.Body>
                            ...
                            <Card.Text>
                                Explore data and countermeasures associated with MITRE ATT&CK techniques.
                            </Card.Text>
                ...
                <Col>
                    <Card className="mb-2" bg="light">
                        <Card.Body>
                            ...
                            <Card.Text>
                                Explore data and countermeasures associated with MITRE ATT&CK subtechniques.
                            </Card.Text>
                ...
                <Col>
                    <Card className="mb-2" bg="light">
                        <Card.Body>
                            <Card.Title>MITRE Matrix</Card.Title>
                            <Card.Text>
                                View MITRE ATT&CK Matrix and associated data.<br/>
                                <br/>
                            </Card.Text>
                            <Button variant="primary" onClick={() => navigate(`/mitre/matrix `)}>View</Button>
                        </Card.Body>
                    </Card>
                </Col>
            </Row>
