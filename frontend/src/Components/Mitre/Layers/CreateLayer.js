...
export default function App(){
    ...
    const handleSubmit = (event) => {
        ...
        MitreDataService.createLayer(formData).then(function (response) {
            ...
            var textarea = document.getElementById('layer-text');
        ...
        <Container>
            <div className="d-flex justify-content-center">
                <div className="w-50 mt-3">
                    ...
                    <a href="https://github.com/mitre-attack/attack-navigator/tree/master/layers">MITRE Layer Information</a><br/>
                    <a href="https://mitre-attack.github.io/attack-navigator/v2/enterprise/">MITRE Layer Navigator</a>
